...
$host = 'draminesaid.com';
$dbname = 'draminesaid_lucci';
$username = 'draminesaid_lucci';
$password = 'Chikhaoui20!';
...
try {
    ...
    switch ($_SERVER['REQUEST_METHOD']) {
        case 'GET':
            ...
            $sql = "SELECT id_message, id_session, sender_type, sender_name, message_content, 
        ...
        case 'POST':
            ...
            $stmt = $pdo->prepare("SELECT * FROM chat_messages WHERE id_message = :id");
        ...
        case 'PUT':
            ...
            $stmt = $pdo->prepare("UPDATE chat_messages 
                                   SET is_read = 1 
                                   WHERE id_session = :session_id AND sender_type = :sender_type");
            $stmt->execute([
                'session_id' => $sessionId,
                'sender_type' => $senderType
            ]);
