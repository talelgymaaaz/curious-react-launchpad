                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                          <div className="space-y-3">
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-semibold" style={{ color: '#212937' }}>{safeToFixed(selectedOrder.sous_total_order)} TND</span>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-semibold" style={{ color: '#212937' }}>{safeToFixed(selectedOrder.delivery_cost_order)} TND</span>
                            </div>
