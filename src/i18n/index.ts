...
import frAssistantTranslations from './locales/assistant/fr.json';
import enAssistantTranslations from './locales/assistant/en.json';
...
const resources = {
  fr: {
    ...
    assistant: frAssistantTranslations,
  },
  en: {
    ...
    assistant: enAssistantTranslations,
  },
};
